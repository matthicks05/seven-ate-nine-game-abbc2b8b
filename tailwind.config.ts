  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "game-table": "hsl(var(--game-table))",
        "game-table-pattern": "hsl(var(--game-table-pattern))",
        "card-bg": "hsl(var(--card-background))",
        "card-border": "hsl(var(--card-border))",
        "card-shadow": "hsl(var(--card-shadow))",
        card: {
          DEFAULT: "hsl(var(--card-background))",
          foreground: "hsl(var(--card-shadow))",
      ...
      animation: {
        ...
        "card-deal": "card-deal 0.5s cubic-bezier(0.4, 0, 0.2, 1)",
